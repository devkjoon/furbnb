...
export default function PetDayCareServices() {
  const services = [
    ...
    },
    {
      name: "Training",
      description:
        "We believe that every pet can benefit from training, and we offer a variety of classes to help your pet learn new skills and behaviors. From obedience training to agility classes, we have something for every pet.",
    },
    {
