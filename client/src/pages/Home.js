    ...
    <div id="main-cont">
      ...
      <div id="cards-div">
        <div className="card">
          ...
          <h4>Luxury Rooms</h4>
          <p>
            Leave them in luxury with our top of the line suites. Featuring
            music, A/C, memory foam beds, and optional exterior views. No we
            don't offer rooms for humans.
          </p>
        ...
        <div className="card">
          ...
          <h4>Quality Care</h4>
          <p>
            No childhood traumas here! Your furry friends will be treated like a
            member of the Royal Family at FurBnB. (Due to legal reasons we do
            not provide armed guards.)
          </p>
          <button className="card-button">
            <span className="material-symbols-outlined card-button-span">
              chevron_right
        ...
        <div className="landing-info" id="landing-info1">
          ...
          <div className="landing-info-text-div">
            ...
            <p>
              ...
              loved one is in great hands. We pride ourselves in the best of
              animal husbandry practices, and personal care to suit every unique
              being's needs.
            </p>
          </div>
        </div>
        <div className="landing-info" id="landing-info2">
          <div className="landing-info-text-div">
            ...
            <p>
              ...
              overwhelmed. We never force a pet to do anything. No matter if you
              have an energetic, working dog, or a slow senior citizen. You have
              our word, they will be cared for in the way that suits them best.
            </p>
          </div>
          <div className="landing-info-image-div">
            <img src={cat} alt="cat" />
        ...
        <div className="landing-info" id="landing-info3">
          ...
          <div className="landing-info-text-div">
            ...
            <p>
              ...
              it up, and have your fur baby coming home shiny, and new. Or you
              can purchase our grooming package for the full spa experience.
              Haircut, bath, nail trimming, fresh scent, and a spiffy little
              bandana to top it off.
            </p>
          </div>
        </div>
      </div>
