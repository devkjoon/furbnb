...
export default function AboutPage() {
  return (
    <div>
      ...
      <p>Our team includes Joon, Liam, Alexandria, Trenton, and Coulson, who bring a wealth of experience and expertise in animal care, training, and behavior to our business. We are dedicated to staying up-to-date with the latest industry trends and best practices to provide the best possible care for your pets.</p>
      ...
      <p>Thank you for considering our pet daycare for your furry family members. We look forward to getting to know you and your pets!</p>
    </div>
  );
}
